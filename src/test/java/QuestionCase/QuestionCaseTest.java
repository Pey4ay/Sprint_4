...
public class QuestionCaseTest {
    ...
    private final String numberQuestion; //Номер вопроса
    private final String answer; //текст ответа

    public QuestionCaseTest(String numberQuestion, String answer){
    ...
    public void checkActivity() {
        ...
        //Убираем кнопку с куки
        homePageQuestion.clickCookieButton();
        //Сравниваем вопросы
        assertEquals(answer, homePageQuestion.clickQuestion(numberQuestion));
    }
